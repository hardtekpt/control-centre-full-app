  ...
  return (
    <>
      ...
      <div className="settings-section">
        ...
        <label className="form-row" title="How often the app polls the Sonar API for state changes">
        ...
        <label className="form-row" title="Which USB input slot the PC is connected to on the base station">
