...
export const DEFAULT_SETTINGS: UiSettings = {
  ...
  services: {
    ...
    presetSwitcherPollIntervalMs: 250,
...
export function mergeSettings(partial?: Partial<UiSettings>): UiSettings {
  ...
  return {
    ...
    services: {
      ...
      presetSwitcherPollIntervalMs: clamp(
        Number(servicesSanitized.presetSwitcherPollIntervalMs ?? DEFAULT_SETTINGS.services.presetSwitcherPollIntervalMs),
        100,
        5_000,
      ),
