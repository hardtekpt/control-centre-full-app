...
export function mergeSettings(partial?: Partial<UiSettings>): UiSettings {
  ...
  return {
    ...
    services: {
      ...
      oledDisplayEnabled: partialSanitized.services?.oledDisplayEnabled === true,
      oledNotificationsEnabled: partialSanitized.services?.oledNotificationsEnabled !== false,
    ...
    baseStationOled: {
      ...
      ...(partialSanitized.baseStationOled ?? {}),
      refreshIntervalMs: clamp(
        Number(partialSanitized.baseStationOled?.refreshIntervalMs ?? DEFAULT_SETTINGS.baseStationOled.refreshIntervalMs),
        5_000,
        300_000,
      ),
      showHeadsetVolume: partialSanitized.baseStationOled?.showHeadsetVolume !== false,
      showMicMuteStatus: partialSanitized.baseStationOled?.showMicMuteStatus !== false,
      showAncMode: partialSanitized.baseStationOled?.showAncMode !== false,
